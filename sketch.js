...
function detectCollision(lstones,lmango){
	...
	if(lstones.body.position.x - lmango.body.position.x < lmango.width/2 + lstones.width/2&&
		lmango.body.position.x - lstones.body.position.x < lmango.width/2 + lstones.width/2 && 
		lstones.body.position.y - lmango.body.position.y < lmango.height/2 + lstones.height/2&&
		lmango.body.position.y - lstones.body.position.y < lmango.height/2 + lstones.height/2){
